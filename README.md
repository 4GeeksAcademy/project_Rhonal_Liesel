...
En este conjunto de datos, el objetivo es predecir la vida útil restante (VLR) de cada motor del conjunto de datos de prueba. La VLR equivale al número de vuelos restantes del motor después del último punto de datos del conjunto de datos de prueba.
